@extends('admin.layout', ['title' => 'Add Education', 'subtitle' => 'Create a new education record.'])
...
@section('content')
    ...
    <div class="content--narrow">
        ...
        <div class="page-head">
            <div>
                <h2>Add Education</h2>
                <p>Record an academic qualification or course.</p>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field @error('degree') has-error @enderror">
                            ...
                            <input class="input" type="text" id="degree" name="degree"
                                   value="{{ old('degree') }}" placeholder="e.g. B.Sc. in Computer Science" required>
                        ...
                        <div class="field field--full @error('description') has-error @enderror">
                            ...
                            <textarea class="textarea rich-text" id="description" name="description" rows="4"
                                      placeholder="Optional details about this program or your achievements.">{{ old('description') }}</textarea>
                        ...
                        <div class="field @error('end_year') has-error @enderror">
                            ...
                            <input class="input" type="number" id="end_year" name="end_year"
                                   value="{{ old('end_year') }}" min="1900" max="{{ (int) date('Y') + 10 }}"
                        ...
                        <div class="field @error('result') has-error @enderror">
                            ...
                            <input class="input" type="text" id="result" name="result"
                                   value="{{ old('result') }}" placeholder="e.g. CGPA 3.75">
